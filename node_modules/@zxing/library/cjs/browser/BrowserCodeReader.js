...
var GlobalHistogramBinarizer_1 = __importDefault(require("../core/common/GlobalHistogramBinarizer"));
...
var BrowserCodeReader = /** @class */ (function () {
    ...
    BrowserCodeReader.prototype.decode = function (element) {
        ...
        try {
            ...
            if (e instanceof NotFoundException_1.default) {
                ...
                var luminanceSource = new HTMLCanvasElementLuminanceSource_1.HTMLCanvasElementLuminanceSource(canvas, false);
                var globalBinarizer = new GlobalHistogramBinarizer_1.default(luminanceSource);
                var fallbackBitmap = new BinaryBitmap_1.default(globalBinarizer);
    ...
    BrowserCodeReader.prototype.createBinaryBitmap = function (mediaElement) {
        ...
        var luminanceSource = new HTMLCanvasElementLuminanceSource_1.HTMLCanvasElementLuminanceSource(canvas, doAutoInvert, this._grayscaleBuffer);
